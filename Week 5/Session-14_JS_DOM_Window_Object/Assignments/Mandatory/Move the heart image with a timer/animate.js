...
function startAnimation(e) {
  ...
  /**
   * After the if statement in startAnimation() that stops the timer, start a timer that 
calls moveImage(clickX, clickY) every 10 milliseconds. Save the timer ID in the 
timerId variable.
   */
...
function moveImage(x, y) {
  ...
  // TODO: Add code here
  //Add an if statement in moveImage() that stops the timer with the ID timerId if (imgX, imgY)
  //is equal to (centerX, centerY). Also set  timerId to null.
